...
# This script uses the employee promotion dataset and the "fem/male" classification strategy described in the paper.
...
ml.save_confusion_matrix_text(cf_matrix, filename="../results/metrics/promotion/rf_female_metrics.txt")
...
ml.save_confusion_matrix_text(cf_matrix, filename="../results/metrics/promotion/gb_female_metrics.txt")
...
ml.save_confusion_matrix_text(cf_matrix, filename="../results/metrics/promotion/rf_male_metrics.txt")
...
# Performance metrics
cf_matrix = confusion_matrix(y_test_male, y_pred_rf_male)
ml.save_confusion_matrix_text(cf_matrix, filename="../results/metrics/promotion/gb_male_metrics.txt")
