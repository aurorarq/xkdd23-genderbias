...
# This script uses the employee promotion dataset and the "mit_post" classification strategy described in the paper.
...
ml.save_confusion_matrix_text(cf_matrix, filename="../metrics/promotion/rf_mit_post_metrics.txt")
...
ml.save_confusion_matrix_text(cf_matrix, filename="../metrics/promotion/gb_mit_post_metrics.txt")
