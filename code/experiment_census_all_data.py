...
# This script uses the dutch census dataset and the "full" classification strategy described in the paper.
...
ml.save_confusion_matrix_text(cf_matrix, filename="../results/metrics/census/rf_all_metrics.txt")
...
ml.save_confusion_matrix_text(cf_matrix, filename="../results/metrics/census/gb_all_metrics.txt")
