...
# This script uses the dutch census dataset and the "no_gender" classification strategy described in the paper.
...
ml.save_confusion_matrix_text(cf_matrix, filename="../results/metrics/census/rf_nogender_metrics.txt")
...
ml.save_confusion_matrix_text(cf_matrix, filename="../results/metrics/census/gb_nogender_metrics.txt")
