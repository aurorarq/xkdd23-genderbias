...
# This script uses the employee promotion dataset and the "mit_in" classification strategy described in the paper.
...
df_eof.to_csv("../results/metrics/promotion/rf_mit_in_eof.csv", index=False)

# Performance metrics
y_pred_rf_mit_in = best_rf.predict(x_test_all)
cf_matrix = confusion_matrix(y_test_all, y_pred_rf_mit_in)
ml.save_confusion_matrix_text(cf_matrix, filename="../results/metrics/promotion/rf_mit_in_metrics.txt")
...
df_eof.to_csv("../results/metrics/promotion/gb_mit_in_eof.csv", index=False)

# Performance metrics
y_pred_gb_mit_in = best_gb.predict(x_test_all)
cf_matrix = confusion_matrix(y_test_all, y_pred_gb_mit_in)
ml.save_confusion_matrix_text(cf_matrix, filename="../results/metrics/promotion/gb_mit_in_metrics.txt")
