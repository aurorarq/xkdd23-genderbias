...
# This script uses the adult dataset and the "full" classification strategy described in the paper.
...
ml.save_confusion_matrix_text(cf_matrix, filename="../results/metrics/adult/rf_all_metrics.txt")
...
ml.save_confusion_matrix_text(cf_matrix, filename="../results/metrics/adult/gb_all_metrics.txt")
