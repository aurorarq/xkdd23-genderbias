...
# This script uses the employee promotion dataset and the "no_gender" classification strategy described in the paper.
...
ml.save_confusion_matrix_text(cf_matrix, filename="../results/metrics/promotion/rf_nogender_metrics.txt")
...
ml.save_confusion_matrix_text(cf_matrix, filename="../results/metrics/promotion/gb_nogender_metrics.txt")
