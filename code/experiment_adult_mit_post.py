...
# This script uses the adult dataset and the "mit_post" classification strategy described in the paper.
...
ml.save_confusion_matrix_text(cf_matrix, filename="../results/metrics/adult/rf_mit_post_metrics.txt")
...
ml.save_confusion_matrix_text(cf_matrix, filename="../results/metrics/adult/gb_mit_post_metrics.txt")
